...
var HDPrivateKey = fcash.HDPrivateKey;
var HDPublicKey = fcash.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = fcash.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(fcash.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(fcash.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      fcash.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = fcash.PublicKey.fromPoint;
      fcash.PublicKey.fromPoint = function() {
        fcash.PublicKey.fromPoint = unstubbed;
