 ...
 * and a slightly fancier format recognized by fcash:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a fcash Address object. The
 * same is true for `script`, which can be a string or a fcash Script.
 *
